      ...
      <header className='bg-white py-3 px-10'>
        <form onSubmit={handleSubmit} className='flex  '>
          <input
            ...
            required
            placeholder='Search..'
            className='bg-footer w-full md:w-1/2 noout py-2 px-4 rounded-s-lg'
            value={searchTerm}
              ...
              <div className='flex-auto'>
                <div className='tab-content tab-space'>
                  <div
                    ...
                    id='link1'
                  >
                    <div className='py-5 flex md:flex-row flex-col w-full gap-10 '>
                      <div className='w-full md:w-1/2 bg-white border-2 rounded-xl'>
                        <div className='p-5'>
                          <h1 className='text-xl pb-1 font-semibold'>
                            Profile Settings
                          </h1>
                          <p className='text-base opacity-80 '>
                            Those are your personal details, they arn't visible
                            to public
                          </p>
                          <Profile />
                        </div>
