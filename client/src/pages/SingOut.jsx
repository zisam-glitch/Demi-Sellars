                        ...
                        <div className='p-5 flex flex-col gap-2'>
                          ...
                          <ul className='text-base opacity-80 flex flex-col gap-2 pb-2'>
                            <li>
                              ...
                              completed any necessary tasks before signing out.
                            </li>
                            <li>
                              <strong>Privacy Check:</strong> If you're using a
                              shared device, make sure to log out to protect
                              your account's privacy.
                            </li>
                            <li>
                              <strong>Stay Updated:</strong> Check for any
                              important announcements, updates, or new features
                              we might have released. Stay in the loop for an
                              enhanced user experience.
                            </li>
                            <li>
                              <strong>Feedback Matters:</strong> We value your
                              feedback. If you have a moment,{" "}
                              <a href='#'>let us know about your experience</a>.
                          ...
                          <div className='flex gap-2'>
                            <p className='text-base opacity-80 '>
                              Remember, we appreciate your trust in us. Have a
                              great day!
                            </p>
                            <SingOut />
                          </div>
